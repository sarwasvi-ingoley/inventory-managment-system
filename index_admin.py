...
def resizer(e):
    ...
    bg1 = Image.open("images\\construction-site-bg_home2_cropped.png")
...
def Database():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS admin (admin_id int PRIMARY KEY NOT NULL AUTO_INCREMENT, username varchar(20), password varchar(50))")
...
def Back():
    result = tkMessageBox.askquestion('ADMIN SIDE', 'Do You Want To Exit To Main Menu?', icon="warning")
    if result == 'yes':
...
bg = ImageTk.PhotoImage(file = "images\\construction-site-bg_home2_cropped.png")

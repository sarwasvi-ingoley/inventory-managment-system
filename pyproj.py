...
def Database():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS product (product_id int PRIMARY KEY  AUTO_INCREMENT, product_name varchar(50), product_qty varchar(20), product_price varchar(10))")
...
######FIRST PAGE#######
bg_home = ImageTk.PhotoImage(file = "images\\construction-site-bg_home2_cropped_1024x520.png")
